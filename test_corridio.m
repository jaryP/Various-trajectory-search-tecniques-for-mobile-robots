...
for i=1:5
    'iterazione'
    i
    rrt = Copy_of_rrtStar(init_conf,final_conf,x_min, x_max,y_min,y_max,obstacles,[],0);
    rrt.core(500);
    [d,~]= rrt.getEndPath();
...
for i=1:5
    ...
    'iterazione'
    i
    rrt = Copy_of_rrt(init_conf,final_conf,x_min, x_max,y_min,y_max,obstacles,area,0.7);
    rrt.core(500);
    [d,~]= rrt.getEndPath();
